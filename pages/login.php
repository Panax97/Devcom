            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <center><h3 class="panel-title">Porfavor Registrese</h3></center>
                    </div>
                    <div class="panel-body">
                        <form role="form" method="post" action="../pages/login_controller.php" >
                            <fieldset>
                                ...
                                <button type="submit" class="btn btn-ttc btn btn-lg  btn-block">Iniciar</button>
                            </br>
                                <center><a href="../pages/nuevoUsuario.php">Registrate</a><br></center>
                            </fieldset>
                        </form>
                    </div>
                </div>
